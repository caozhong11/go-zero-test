...
type UserServiceClient interface {
	GetUserList(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetUserList(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) GetUserList(context.Context, *UserRequest) (*UserResponse, error) {
